...
class TriadeRankingLicao extends StatelessWidget {
  const TriadeRankingLicao({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var patient = rankingMock.pacientes;
    patient.sort((p1, p0) =>
        p0.licoes[0].notaLicao.value.compareTo(p1.licoes[0].notaLicao.value));
            ...
            children: <Widget>[
              ...
              patient.length >= 2
                  ? CustomCircleAvatar(
                      ...
                      pontuacao: patient[1].licoes[0].notaLicao.value,
                    )
            ...
            children: <Widget>[
              ...
              patient.length >= 3
                  ? CustomCircleAvatar(
                      ...
                      pontuacao: patient[2].licoes[0].notaLicao.value,
                    )
                  : const CustomCircleAvatar(
                      usuario: '',
                      size: 100,
            ...
            children: <Widget>[
              ...
              patient.isNotEmpty
                  ? CustomCircleAvatar(
                      ...
                      pontuacao: patient[0].licoes[0].notaLicao.value,
                    )
                  : const CustomCircleAvatar(
                      usuario: '',
                      size: 100,
