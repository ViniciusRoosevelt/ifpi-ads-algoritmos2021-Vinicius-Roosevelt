// Copiado e adaptado do widget oficial do Flutter
...
/// [ActivityExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ActivityExpansionTile].
///
...
class ActivityExpansionTile extends StatefulWidget {
  ...
  @override
  State<ActivityExpansionTile> createState() => _ActivityExpansionTileState();
}

class _ActivityExpansionTileState extends State<ActivityExpansionTile>
